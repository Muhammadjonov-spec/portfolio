...
import uploadOptions from "../features/upload/uploadOptions.js"
...
const projectResource={
  resource:Project,
  features:[uploadOptions({bucket: "uploads/projects", property: "image"})],
  options:{
    ...
    editProperties:["title", "subtitle", "description", "uploadFile", "liveUrl",  "githubUrl", "technologies", "featured", "published", "projectDate", "sortOrder"],
    ...
    properties:{image:{isVisible:false}, slug:{isVisible:false}, ...properties}, 
    actions:{
